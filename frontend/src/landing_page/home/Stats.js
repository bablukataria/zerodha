        ...
        <div className='container'>
            <div className='row p-5'>
               <div className='col-6 p-5'>
                 <h1 className=' fs-2 mb-5'>Trust me Confidence</h1>
                ...
                <div className='col-6 p-5'>
                    ...
                    <div className='text-center'>
                        <a href='' className='mx-5'  style={{ textDecoration: "none" }}>Explore you products <i className="fa-solid fa-arrow-right"></i></a>
                        <a href='' style={{ textDecoration: "none" }}>Try Kit <i className="fa-solid fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
